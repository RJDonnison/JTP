...
class PropertiesUtilTest {
    ...
    @Test
    void shouldGetBooleanPropertyFromFile(@TempDir Path tempDir) throws IOException {
        File propFile = tempDir.resolve("numbers.properties").toFile();
    ...
    @Test
    void shouldGetBooleanPropertyFromFileWithoutExtension(@TempDir Path tempDir) throws IOException {
        File propFile = tempDir.resolve("numbers").toFile();
        writeProperties(propFile, "port", "true");

        assertTrue(PropertiesUtil.getBoolean(propFile.getAbsolutePath(), "port"));
    }

    @Test
    void shouldReturnNullForNonExistentFileWhenGettingBoolean() {
        assertNull(PropertiesUtil.getBoolean("nonexistent.properties", "any.key"));
    }
